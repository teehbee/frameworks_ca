  ...
  return (
    <div className="container text-center py-5">
      ...
      <form onSubmit={onFormSubmit} className="contact-form d-flex flex-column mx-auto py-3 py-md-5 text-start">
        <label className="fs-0-75rem-to-1-rem mb-1" htmlFor={id + "-fullName"}>
        ...
        <label className="fs-0-75rem-to-1-rem mb-1" htmlFor={id + "-emailAddress"}>
        ...
        <button className="green-button button-square py-1 py-md-2">Send message</button>
      </form>
    </div>
  );
}
